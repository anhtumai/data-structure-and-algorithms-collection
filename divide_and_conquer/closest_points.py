...
Example:
find_closest_points([(2, 3), (12, 30), (40, 50), (5, 1), (12, 10), (3, 4), (1, 1), (-900, 3), (100, 3)])
-> ((2,3), (3,4))
"""
import math
...
def find_closest_points(points: list[Point]) -> tuple[Point, Point]:
    Px = column_base_sort(points, 0)
    Py = column_base_sort(points, 1)
    return _recurs_find_closest_points(Px, Py)


def _recurs_find_closest_points(Px: list[Point], Py: list[Point]) -> tuple[Point, Point]:
    n_point = len(Px)
    ...
    lp1, lp2 = _recurs_find_closest_points(Qx, Qy)
    rp1, rp2 = _recurs_find_closest_points(Rx, Ry)
    ...
    sp1, sp2 = _find_closest_points_split(Py, x_threshold, d)
...
def _find_closest_points_split(points, x_threshold, delta: float) -> tuple[Point, Point]:
...
if __name__ == "__main__":
    ...
    print(find_closest_points(ps1))  # ((2,3),(5,1))
    ps2 = [(2, 3), (12, 30), (40, 50), (5, 1),
           (12, 10), (3, 4), (1, 1), (-900, 3), (100, 3)]
    print(find_closest_points(ps2))  # ((2,3),(3,4))
    ps3 = [(1, 1), (1, 1), (42, 12), (1, 4), (9, -3)]
    print(find_closest_points(ps3))  # ((1,1),(1,1))
